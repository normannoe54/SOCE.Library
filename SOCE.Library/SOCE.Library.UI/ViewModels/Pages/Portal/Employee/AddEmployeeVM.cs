...
namespace SOCE.Library.UI.ViewModels
{
    public class AddEmployeeVM : BaseVM
    {
        ...
        public void AddEmployee()
        {
            ...
            if (String.IsNullOrEmpty(FirstNameInp) || String.IsNullOrEmpty(LastNameInp) || SelectedAuthorization == null || SelectedDefaultRole == null || String.IsNullOrEmpty(EmailInp) || String.IsNullOrEmpty(TemporaryPassInp))
            {
